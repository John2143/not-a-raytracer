...
//This function is not made to be fast, its made to be safe and easy to
//reason with
//Basic linear interpolate from range [stval, enval] to [newst, newen]
...
//I haven't written either of these funcitons.
